...
async def create_grade(db: AsyncSession, grade: schemas.GradeCreate) -> Grade:
...
async def update_grade(db: AsyncSession, grade_id: int, grade_data: schemas.GradeUpdate) -> Optional[Grade]:
