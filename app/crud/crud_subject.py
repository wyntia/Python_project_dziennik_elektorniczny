...
async def create_subject(db: AsyncSession, subject: schemas.SubjectCreate) -> Subject:
...
async def update_subject(db: AsyncSession, subject_id: int, subject_data: schemas.SubjectUpdate) -> Optional[Subject]:
